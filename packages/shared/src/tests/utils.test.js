import { capitalize, checkIsAbsoluteUrl, checkIsNonNullable, formatCurrency, normalizeString, removeSearchQuery, } from "../utils";
describe("capitalize", () => {
...
describe("removeSearchQuery", () => {
    it("should remove the search query from a url", () => {
        expect(removeSearchQuery("https://en.wikipedia.org/wiki/Software_development?search=software#Hello")).toBe("https://en.wikipedia.org/wiki/Software_development");
    });
});
