type ReplicateModelInputOutput = {
...
// Add more as needed
export type ModelInputOutput = ReplicateModelInputOutput;

export type ModelName = keyof ModelInputOutput;

export const defaultModelInput: Record<
  ModelName,
  ModelInputOutput[ModelName]["input"]
> = {
  "victor-upmeet/whisperx:84d2ad2d6194fe98a17d2b60bef1c7f910c46b2f6fd38996ca457afd9c8abfcb":
    {
      debug: false,
